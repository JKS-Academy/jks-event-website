...
const arabicContent = {
    ...
    footerContent: " من الإثنين إلى الجمعة<br /> تاريخ ووقت المخيم الربيعي: 18 مارس إلى 5 أبريل 2024،<br />دبي ديجيتال بارك، دي 3 ريزيدنس، واحة دبي للسيليكون",
...
const englishContent = {
    ...
    footerContent: "Dubai Digital Park, D3 Residence, Dubai Silicon Oasis <br /> Spring Camp Date & Time : 18th March to 5th April 2024,<br/> Monday to Friday <br/>",
