...
const englishContent = {
  footerContent:
    "Dubai Digital Park, D3 Residence, Dubai Silicon Oasis <br /> Spring Camp Date & Time : 18th March to 5th April 2024,<br/> Monday to Friday <br/>",
...
const setEnglish = () => {
  ...
  if (document.getElementById("labelKidsName"))
    document.getElementById("labelKidsName").innerHTML = englishContent.nameOfKid;
...
const setArabic = () => {
  ...
  if (document.getElementById("labelKidsName"))
    document.getElementById("labelKidsName").innerHTML = arabicContent.nameOfKid;
  if (document.getElementById("labelKidsAge"))
