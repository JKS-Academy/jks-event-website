const arabicContent = {
  ...
  getNotifiedDescription:
    "تواصل مع أكاديمية JKS واحصل على إشعارات بشأن الأحداث القادمة",
...
const setEnglish = () => {
  ...
  if (document.getElementById("worldHub"))
  ...
  if (document.getElementById("jksDescription"))
    document.getElementById("jksDescription").innerHTML =
      englishContent.jksDescription;
  if (document.getElementById("getNotified"))
    document.getElementById("getNotified").innerHTML =
      englishContent.getNotified;
  if (document.getElementById("getNotifiedDescription"))
    document.getElementById("getNotifiedDescription").innerHTML =
      englishContent.getNotifiedDescription;
  if (document.getElementById("labelPlayerName"))
    document.getElementById("labelPlayerName").innerHTML =
      englishContent.playerName;
  if (document.getElementById("labelDob"))
    document.getElementById("labelDob").innerHTML = englishContent.dob;
  if (document.getElementById("labelAge"))
    document.getElementById("labelAge").innerHTML = englishContent.age;
  if (document.getElementById("labelSex"))
    document.getElementById("labelSex").innerHTML = englishContent.sex;
  if (document.getElementById("optionSex"))
    document.getElementById("optionSex").innerHTML = englishContent.sex;
  if (document.getElementById("labelBelt"))
    document.getElementById("labelBelt").innerHTML = englishContent.category;
  if (document.getElementById("optionBelt"))
    document.getElementById("optionBelt").innerHTML = englishContent.category;
  if (document.getElementById("labelHeight"))
    document.getElementById("labelHeight").innerHTML = englishContent.height;
  if (document.getElementById("labelWeight"))
    document.getElementById("labelWeight").innerHTML = englishContent.weight;
  if (document.getElementById("labelCountry"))
    document.getElementById("labelCountry").innerHTML = englishContent.country;
  ...
  if (document.getElementById("labelEvents"))
    document.getElementById("labelEvents").innerHTML = englishContent.events;
  if (document.getElementById("labelClubName"))
    document.getElementById("labelClubName").innerHTML =
      englishContent.clubName;
  if (document.getElementById("labelInsructorName"))
    document.getElementById("labelInsructorName").innerHTML =
      englishContent.instructorName;
  if (document.getElementById("labelFood"))
    document.getElementById("labelFood").innerHTML = englishContent.food;
  if (document.getElementById("optionFood"))
    document.getElementById("optionFood").innerHTML = englishContent.food;
  if (document.getElementById("labelWaiver"))
    document.getElementById("labelWaiver").innerHTML =
      englishContent.waiverDescription;
  if (document.getElementById("waiverButton"))
    document.getElementById("waiverButton").innerHTML = englishContent.waiver;
...
const setArabic = () => {
  ...
  if (document.getElementById("jksDescription"))
    document.getElementById("jksDescription").innerHTML =
      arabicContent.jksDescription;
  if (document.getElementById("getNotified"))
    document.getElementById("getNotified").innerHTML =
      arabicContent.getNotified;
  if (document.getElementById("getNotifiedDescription"))
    document.getElementById("getNotifiedDescription").innerHTML =
      arabicContent.getNotifiedDescription;
  if (document.getElementById("labelPlayerName"))
    document.getElementById("labelPlayerName").innerHTML =
      arabicContent.playerName;
  if (document.getElementById("labelDob"))
    document.getElementById("labelDob").innerHTML = arabicContent.dob;
  if (document.getElementById("labelAge"))
    document.getElementById("labelAge").innerHTML = arabicContent.age;
  if (document.getElementById("labelSex"))
    document.getElementById("labelSex").innerHTML = arabicContent.sex;
  if (document.getElementById("optionSex"))
    document.getElementById("optionSex").innerHTML = arabicContent.sex;
  if (document.getElementById("labelBelt"))
    document.getElementById("labelBelt").innerHTML = arabicContent.category;
  if (document.getElementById("optionBelt"))
    document.getElementById("optionBelt").innerHTML = arabicContent.category;
  if (document.getElementById("labelHeight"))
    document.getElementById("labelHeight").innerHTML = arabicContent.height;
  if (document.getElementById("labelWeight"))
    document.getElementById("labelWeight").innerHTML = arabicContent.weight;
  if (document.getElementById("labelCountry"))
    document.getElementById("labelCountry").innerHTML = arabicContent.country;
  if (document.getElementById("labelMobile"))
  ...
  if (document.getElementById("labelEvents"))
    document.getElementById("labelEvents").innerHTML = arabicContent.events;
  if (document.getElementById("labelClubName"))
    document.getElementById("labelClubName").innerHTML = arabicContent.clubName;
  if (document.getElementById("labelInsructorName"))
    document.getElementById("labelInsructorName").innerHTML =
      arabicContent.instructorName;
  if (document.getElementById("labelFood"))
    document.getElementById("labelFood").innerHTML = arabicContent.food;
  if (document.getElementById("optionFood"))
    document.getElementById("optionFood").innerHTML = arabicContent.food;
  if (document.getElementById("labelWaiver"))
    document.getElementById("labelWaiver").innerHTML =
      arabicContent.waiverDescription;
  if (document.getElementById("waiverButton"))
    document.getElementById("waiverButton").innerHTML = arabicContent.waiver;
